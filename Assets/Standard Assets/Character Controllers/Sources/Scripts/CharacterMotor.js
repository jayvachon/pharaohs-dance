...
// Set stop to true and the character will stop on a dime
...
private function UpdateFunction () {
	...
	if (MoveWithPlatform()) {
		...
		if (moveDistance != Vector3.zero && controller.gameObject.activeSelf)
...
function SetVelocity (velocity : Vector3) {
	...
	// If things start acting weird, uncomment this
